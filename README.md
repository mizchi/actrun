...
- `uses: actions/upload-artifact@*` / `uses: actions/download-artifact@*` の最小 builtin emulator (`directory`, wildcard path, `if-no-files-found`, download-all directory mode)
